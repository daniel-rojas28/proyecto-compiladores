...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\2\3\2\3\2\3\3\3\3\3\3\3\3\3\4\3\4\3\4\3\5\3\5\3\5\3\5")
        ...
        buf.write("\2\7Q\3\2\2\2\tT\3\2\2\2\13X\3\2\2\2\r[\3\2\2\2\17`\3")
        buf.write("\2\2\2\21f\3\2\2\2\23m\3\2\2\2\25s\3\2\2\2\27u\3\2\2\2")
        buf.write("\31w\3\2\2\2\33z\3\2\2\2\35|\3\2\2\2\37~\3\2\2\2!\u0080")
        ...
        buf.write("\2\2L\4\3\2\2\2MN\7n\2\2NO\7g\2\2OP\7p\2\2P\6\3\2\2\2")
        buf.write("QR\7k\2\2RS\7h\2\2S\b\3\2\2\2TU\7h\2\2UV\7q\2\2VW\7t\2")
        buf.write("\2W\n\3\2\2\2XY\7k\2\2YZ\7p\2\2Z\f\3\2\2\2[\\\7g\2\2\\")
        buf.write("]\7n\2\2]^\7u\2\2^_\7g\2\2_\16\3\2\2\2`a\7y\2\2ab\7j\2")
        buf.write("\2bc\7k\2\2cd\7n\2\2de\7g\2\2e\20\3\2\2\2fg\7t\2\2gh\7")
        buf.write("g\2\2hi\7v\2\2ij\7w\2\2jk\7t\2\2kl\7p\2\2l\22\3\2\2\2")
        buf.write("mn\7r\2\2no\7t\2\2op\7k\2\2pq\7p\2\2qr\7v\2\2r\24\3\2")
        buf.write("\2\2st\7?\2\2t\26\3\2\2\2uv\7.\2\2v\30\3\2\2\2wx\7?\2")
        buf.write("\2xy\7?\2\2y\32\3\2\2\2z{\7*\2\2{\34\3\2\2\2|}\7+\2\2")
        buf.write("}\36\3\2\2\2~\177\7-\2\2\177 \3\2\2\2\u0080\u0081\7,\2")
        buf.write("\2\u0081\"\3\2\2\2\u0082\u0083\7\61\2\2\u0083$\3\2\2\2")
        buf.write("\u0084\u0085\7@\2\2\u0085&\3\2\2\2\u0086\u0087\7>\2\2")
        buf.write("\u0087(\3\2\2\2\u0088\u0089\7<\2\2\u0089*\3\2\2\2\u008a")
        buf.write("\u008b\7/\2\2\u008b,\3\2\2\2\u008c\u008d\7]\2\2\u008d")
        buf.write(".\3\2\2\2\u008e\u008f\7_\2\2\u008f\60\3\2\2\2\u0090\u0091")
...
class minipythonLexer(Lexer):
    ...
    literalNames = [ "<INVALID>",
            "'def'", "'len'", "'if'", "'for'", "'in'", "'else'", "'while'", 
            "'return'", "'print'", "'='", "','", "'=='", "'('", "')'", "'+'", 
            "'*'", "'/'", "'>'", "'<'", "':'", "'-'", "'['", "']'", "'<='", 
            "'>='" ]

    symbolicNames = [ "<INVALID>",
            "DEF", "LEN", "IF", "FOR", "IN", "ELSE", "WHILE", "RETURN", 
            "PRINT", "EQUAL", "COMMA", "COMPARISON", "LEFTPARENT", "RIGTHPARENT", 
            "SUM", "MULTIPLICATION", "DIVISION", "HIGHER", "LESS", "COLON", 
            "SUBTRACTION", "LEFTKICK", "RIGTHKICK", "LESSOREQUAL", "HIGHEROREQUAL", 
            "CHAR", "NUM", "IDENTIFIER", "STRING", "NEWLINE", "WS", "BLOK_COMMENT", 
            "COMMENT" ]

    ruleNames = [ "DEF", "LEN", "IF", "FOR", "IN", "ELSE", "WHILE", "RETURN", 
                  "PRINT", "EQUAL", "COMMA", "COMPARISON", "LEFTPARENT", 
                  "RIGTHPARENT", "SUM", "MULTIPLICATION", "DIVISION", "HIGHER", 
                  "LESS", "COLON", "SUBTRACTION", "LEFTKICK", "RIGTHKICK", 
                  "LESSOREQUAL", "HIGHEROREQUAL", "L", "N", "CHAR", "NUM", 
                  "IDENTIFIER", "STRING", "NEWLINE", "WS", "BLOK_COMMENT", 
                  "COMMENT" ]
